...
export const FETCH_PROPERTYARRAYDATA_SUCCESS = 'FETCH_PROPERTYARRAYDATA_SUCCESS';
export const FETCH_PROPERTYARRAYDATA_FAILURE = 'FETCH_PROPERTYARRAYDATA_FAILURE';
