...
//                               <AgentOwnerProperties />

//                           </RequireAuth> </PersistLogin>
//                         ),
//                       },
//                     {
//                         path: '/dashboard/special-pages/billing',
...
//                         )
//                     },
//                     // Add other routes wrapped with RequireAuth as needed
//                     {
//                         path: 'dashboard/icon/dual-tone',
//                         element: (
//                             <RequireAuth allowedRoles={[/* Define allowed roles here */]}>
//                                 <DualTone />
//                             </RequireAuth>
//                         )
//                     }
        ...
        <Routes>
          ...
          <Route element={<PersistLogin />}>
            ...
            <Route element={<RequireAuth allowedRoles={[2000]} />}>
              <Route path="/home/tenant" element={<AgentOwnerProperties />} />
            </Route>

            {/* protected agents */}
            <Route element={<RequireAuth allowedRoles={[3000, 5000]} />}>
              <Route path="/home/agent" element={<AgentOwnerProperties />} />
            </Route>

            <Route element={<RequireAuth allowedRoles={[4000, 5000]} />}>
              <Route path="/home/owner" element={<AgentOwnerProperties />} />
            </Route>

            <Route element={<RequireAuth allowedRoles={[4000, 3000, 5000]} />}>
              <Route path="/manage/units" element={<AgentOwnerProperties />} />
            </Route>
