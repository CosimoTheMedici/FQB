...
import AgentOwnerLayout from "../../layouts/mainlayout/AgentOwnerLayout.js";

// install Swiper modules
SwiperCore.use([Navigation]);

const AgentOwnerDashboard = memo((props) => {
...
export default AgentOwnerLayout(AgentOwnerDashboard)
